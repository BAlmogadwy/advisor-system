...
def test_http_login_normalizes_arabic_digits_and_displays_the_canonical_44_email(students):
    legacy_id = 4402162
...
def test_retired_redirect_settings_cannot_change_telegram_link_otp_recipient(students):
...
def test_retired_test_controls_cannot_bypass_otp_or_redirect_delivery(students):
    c = Client()
    mail.outbox = []
