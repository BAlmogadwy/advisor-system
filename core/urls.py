...
from .timetable_workspace_views import (
    ...
    tw_board_planned_slot_candidates_view,
    ...
    tw_placement_student_outcome_candidates_view,
    tw_repair_analyse_view,
    tw_repair_candidate_apply_view,
    tw_repair_candidate_approve_view,
    tw_repair_candidate_detail_view,
    tw_repair_global_plan_apply_view,
    tw_repair_global_plan_approve_view,
    tw_repair_global_plan_create_view,
    tw_repair_global_plan_detail_view,
    tw_repair_global_plan_rollback_view,
    tw_repair_job_cancel_view,
    tw_repair_job_list_view,
    tw_repair_job_poll_view,
    tw_repair_job_recover_stale_view,
    tw_repair_job_result_view,
    tw_repair_job_retry_view,
    tw_repair_job_submit_view,
    tw_repair_run_detail_view,
    tw_repair_run_report_view,
    tw_repair_run_rollback_view,
    tw_repair_simulate_view,
    tw_scenario_budget_view,
    tw_scenario_builder_actions_view,
    tw_scenario_clean_room_assignments_apply_view,
    ...
    tw_scenario_safe_time_moves_apply_view,
    tw_scenario_safe_time_moves_view,
...
urlpatterns = [
    ...
    path(
        "ops/tw/scenarios/<int:scenario_id>/clean-room-assignments/",
        tw_scenario_clean_room_assignments_view,
        name="tw_scenario_clean_room_assignments",
    ),
    path(
        "ops/tw/scenarios/<int:scenario_id>/clean-room-assignments/apply/",
        tw_scenario_clean_room_assignments_apply_view,
        name="tw_scenario_clean_room_assignments_apply",
    ),
    path(
        "ops/tw/scenarios/<int:scenario_id>/safe-time-moves/",
        tw_scenario_safe_time_moves_view,
        name="tw_scenario_safe_time_moves",
    ),
    path(
        "ops/tw/scenarios/<int:scenario_id>/safe-time-moves/apply/",
        tw_scenario_safe_time_moves_apply_view,
        name="tw_scenario_safe_time_moves_apply",
    ),
    path(
    ...
    path(
        "ops/tw/scenarios/<int:scenario_id>/student-blockers/",
        tw_scenario_student_blockers_view,
        name="tw_scenario_student_blockers",
    ),
    ...
    path(
        "ops/tw/boards/<int:board_id>/planned-slot-candidates/",
        tw_board_planned_slot_candidates_view,
        name="tw_board_planned_slot_candidates",
    ),
    ...
    path(
        "ops/tw/placements/<int:placement_id>/student-outcome-candidates/",
        tw_placement_student_outcome_candidates_view,
        name="tw_placement_student_outcome_candidates",
    ),
    path(
    ...
    path(
        ...
        tw_repair_analyse_view,
        name="tw_repair_analyse",
    ),
    path(
        "ops/tw/repair/simulate/",
        tw_repair_simulate_view,
        name="tw_repair_simulate",
    ),
    path(
        "ops/tw/repair/jobs/",
        tw_repair_job_submit_view,
        name="tw_repair_job_submit",
    ),
    path(
        "ops/tw/repair/jobs/recover-stale/",
        tw_repair_job_recover_stale_view,
        name="tw_repair_job_recover_stale",
    ),
    path(
        "ops/tw/repair/jobs/list/",
        tw_repair_job_list_view,
        name="tw_repair_job_list",
    ),
    path(
        "ops/tw/repair/jobs/<uuid:job_id>/",
        tw_repair_job_poll_view,
        name="tw_repair_job_poll",
    ),
    path(
        "ops/tw/repair/jobs/<uuid:job_id>/result/",
        tw_repair_job_result_view,
        name="tw_repair_job_result",
    ),
    path(
        "ops/tw/repair/jobs/<uuid:job_id>/cancel/",
        tw_repair_job_cancel_view,
        name="tw_repair_job_cancel",
    ),
    path(
        "ops/tw/repair/jobs/<uuid:job_id>/retry/",
        tw_repair_job_retry_view,
        name="tw_repair_job_retry",
    ),
    path(
        "ops/tw/repair/global-plans/",
        tw_repair_global_plan_create_view,
        name="tw_repair_global_plan_create",
    ),
    path(
        "ops/tw/repair/global-plans/<uuid:plan_id>/",
        tw_repair_global_plan_detail_view,
        name="tw_repair_global_plan_detail",
    ),
    path(
        "ops/tw/repair/global-plans/<uuid:plan_id>/approve/",
        tw_repair_global_plan_approve_view,
        name="tw_repair_global_plan_approve",
    ),
    path(
        "ops/tw/repair/global-plans/<uuid:plan_id>/apply/",
        tw_repair_global_plan_apply_view,
        name="tw_repair_global_plan_apply",
    ),
    path(
        "ops/tw/repair/global-plans/<uuid:plan_id>/rollback/",
        tw_repair_global_plan_rollback_view,
        name="tw_repair_global_plan_rollback",
    ),
    path(
        "ops/tw/repair/runs/<uuid:run_id>/",
        tw_repair_run_detail_view,
        name="tw_repair_run_detail",
    ),
    path(
        "ops/tw/repair/runs/<uuid:run_id>/report/",
        tw_repair_run_report_view,
        name="tw_repair_run_report",
    ),
    path(
        "ops/tw/repair/runs/<uuid:run_id>/candidates/<str:candidate_id>/",
        tw_repair_candidate_detail_view,
        name="tw_repair_candidate_detail",
    ),
    path(
        "ops/tw/repair/runs/<uuid:run_id>/candidates/<str:candidate_id>/approve/",
        tw_repair_candidate_approve_view,
        name="tw_repair_candidate_approve",
    ),
    path(
        "ops/tw/repair/runs/<uuid:run_id>/candidates/<str:candidate_id>/apply/",
        tw_repair_candidate_apply_view,
        name="tw_repair_candidate_apply",
    ),
    path(
        "ops/tw/repair/runs/<uuid:run_id>/rollback/",
        tw_repair_run_rollback_view,
        name="tw_repair_run_rollback",
    ),
    path(
