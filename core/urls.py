...
urlpatterns = [
    ...
    path("report/recommendation-debug/", recommendation_debug_view, name="recommendation_debug_view"),
    path("report/course-eligibility/", course_eligibility_view, name="course_eligibility_view"),
    path("report/missing-high-priority/", missing_high_priority_view, name="missing_high_priority_view"),
    path("export/recommendation-debug.csv", export_recommendation_debug_csv_view, name="export_recommendation_debug_csv"),
    path("export/course-eligibility.csv", export_course_eligibility_csv_view, name="export_course_eligibility_csv"),
    path("export/missing-high-priority.xlsx", export_missing_high_priority_xlsx_view, name="export_missing_high_priority_xlsx"),
    path("export/students-by-advisor.csv", export_students_by_advisor_csv_view, name="export_students_by_advisor_csv"),
    ...
    path("ops/advisors/ensure-students-column/", ensure_students_advisor_column_view, name="ensure_students_advisor_column"),
    path("ops/advisors/assign-students/", assign_students_advisors_view, name="assign_students_advisors"),
    ...
    path("ops/sections-import/preview/", sections_import_preview_view, name="sections_import_preview"),
    ...
    path("ops/planner/save-student-sections/", planner_save_student_sections_view, name="planner_save_student_sections"),
    path("ops/planner/sections-catalog/", planner_sections_catalog_view, name="planner_sections_catalog"),
    ...
    path("ops/db/preview-delete-students/", db_preview_delete_students_view, name="db_preview_delete_students"),
    ...
    path("ops/db/delete-program-catalog/", db_delete_program_catalog_view, name="db_delete_program_catalog"),
    ...
    path("ops/db/preview-term-sections/", db_preview_term_sections_view, name="db_preview_term_sections"),
    path("ops/db/import-term-sections/", db_import_term_sections_view, name="db_import_term_sections"),
